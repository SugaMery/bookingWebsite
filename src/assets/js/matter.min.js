    ...
    return function e(t, n, o) {
                ...
                o.set = function(e, t, n) {
                    ...
                    if (1 !== e.parts.length) {
                        if (r = void 0 === r || r) {
                            ...
                            var c = i.hull(l),
                                d = i.centre(c);
                            o.setVertices(e, c), i.translate(e.vertices, d)
                        }
                        var u = t(e);
                        e.area = u.area, e.parent = e, e.position.x = u.centre.x, e.position.y = u.centre.y, e.positionPrev.x = u.centre.x, e.positionPrev.y = u.centre.y, o.setMass(e, u.mass), o.setInertia(e, u.inertia), o.setPosition(e, u.centre)
                    }
                    ...
                    for (var a = 0; a < e.parts.length; a++) {
                        var d = e.parts[a];
                        i.scale(d.vertices, n, r, e.position), d.axes = c.fromVertices(d.vertices), e.isStatic || (d.area = i.area(d.vertices), o.setMass(d, e.density * d.area), i.translate(d.vertices, {
                            x: -d.position.x,
                            y: -d.position.y
                        }), o.setInertia(d, i.inertia(d.vertices, d.mass)), i.translate(d.vertices, {
                            x: d.position.x,
                            y: d.position.y
                    ...
                    if (e.circleRadius && (n === r ? e.circleRadius *= n : e.circleRadius = null), !e.isStatic) {
                        var u = t(e);
                        e.area = u.area, o.setMass(e, u.mass), o.setInertia(e, u.inertia)
                    }
                    ...
                    for (var p = 0; p < e.parts.length; p++) {
                        var m = e.parts[p];
                        i.translate(m.vertices, e.velocity), p > 0 && (m.position.x += e.velocity.x, m.position.y += e.velocity.y), 0 !== e.angularVelocity && (i.rotate(m.vertices, e.angularVelocity, e.position), c.rotate(m.axes, e.angularVelocity), p > 0 && r.rotateAbout(m.position, e.angularVelocity, e.position, m.position)), l.update(m.bounds, m.vertices, e.velocity)
                    }
            ...
            ! function() {
                            ...
                            if (!h.region || b.id !== h.region.id || r) {
                                ...
                                for (p = w.startCol; p <= w.endCol; p++)
                                    for (m = w.startRow; m <= w.endRow; m++) {
                                        ...
                                        !S && C && C && f && d(n, f, h), (h.region === b || S && !C || r) && (f || (f = l(g, v)), c(n, f, h))
                                    }
                                h.region = b, x = !0
                            }
                        }
                ...
                var e = function(e, t) {
                    ...
                    u = function(e) {
                        var t, n, o = [];
                        t = s.keys(e.pairs);
                        for (var i = 0; i < t.length; i++)(n = e.pairs[t[i]])[2] > 0 ? o.push(n) : delete e.pairs[t[i]];
                        return o
                    }
            }()
        }, {
        ...
        8: [function(e, t, n) {
            ...
            o.create = function(e) {
                ...
                var o, s, a, l, c = e.list,
                    ...
                    m = e.collisionActive,
                    f = [];
                for (u.length = 0, p.length = 0, m.length = 0, l = 0; l < t.length; l++)(o = t[l]).collided && (s = i.id(o.bodyA, o.bodyB), f.push(s), (a = d[s]) ? (a.isActive ? m.push(a) : u.push(a), i.update(a, o, n)) : (a = i.create(o, n), d[s] = a, u.push(a), c.push(a)));
                for (l = 0; l < c.length; l++)(a = c[l]).isActive && -1 === r.indexOf(f, a.id) && (i.setActive(a, !1, n), p.push(a))
            }, o.removeOld = function(e, t) {
                var n, o, i, r, s = e.list,
                    a = e.table,
                    l = [];
                for (r = 0; r < s.length; r++)(o = (n = s[r]).collision).bodyA.isSleeping || o.bodyB.isSleeping ? n.timeUpdated = t : t - n.timeUpdated > 1e3 && l.push(r);
                for (r = 0; r < l.length; r++) delete a[(n = s[i = l[r] - r]).id], s.splice(i, 1)
            }, o.clear = function(e) {
                    ...
                    if (s.overlaps(v.bounds, p.bounds))
                        for (var y = 1 === v.parts.length ? 0 : 1; y < v.parts.length; y++) {
                            ...
                            if (s.overlaps(g.bounds, p.bounds)) {
                                ...
                                if (x.collided) {
                                    x.body = x.bodyA = x.bodyB = v, m.push(x);
                                    break
                                }
                            }
                        }
        ...
        10: [function(e, t, n) {
            ...
            o._restingThresh = 4, o._restingThreshTangent = 6, o._positionDampen = .9, o._positionWarming = .8, o._frictionNormalMultiplier = 5, o.preSolvePosition = function(e) {
                ...
                var n, i, s, a, l, c, d, u, p, m = r._temp[0],
                    f = r._temp[1],
                    v = r._temp[2],
                    y = r._temp[3];
                for (n = 0; n < e.length; n++)(i = e[n]).isActive && !i.isSensor && (a = (s = i.collision).parentA, l = s.parentB, c = s.normal, d = r.sub(r.add(l.positionImpulse, l.position, m), r.add(a.positionImpulse, r.sub(l.position, s.penetration, f), v), y), i.separation = r.dot(c, d));
                ...
                var t, n, o, i, s, a, l, c, d, u, p, m, f, v, y = r._temp[0],
                    g = r._temp[1];
                for (t = 0; t < e.length; t++)
                    if ((o = e[t]).isActive && !o.isSensor)
                        for (i = o.activeContacts, a = (s = o.collision).parentA, l = s.parentB, c = s.normal, d = s.tangent, n = 0; n < i.length; n++) p = (u = i[n]).vertex, m = u.normalImpulse, f = u.tangentImpulse, 0 === m && 0 === f || (y.x = c.x * m + d.x * f, y.y = c.y * m + d.y * f, a.isStatic || a.isSleeping || (v = r.sub(p, a.position, g), a.positionPrev.x += y.x * a.inverseMass, a.positionPrev.y += y.y * a.inverseMass, a.anglePrev += r.cross(v, y) * a.inverseInertia), l.isStatic || l.isSleeping || (v = r.sub(p, l.position, g), l.positionPrev.x -= y.x * l.inverseMass, l.positionPrev.y -= y.y * l.inverseMass, l.anglePrev -= r.cross(v, y) * l.inverseInertia))
                    ...
                    if (m.isActive && !m.isSensor) {
                        ...
                        for (var w = 0; w < h.length; w++) {
                            var S = h[w],
                                ...
                                F = T,
                                O = 1 / 0;
                            V > m.friction * m.frictionStatic * E * n && (O = V, F = s.clamp(m.friction * R * n, -O, O));
                            var L = r.cross(A, g),
                                W = r.cross(P, g),
                            ...
                            i.x = g.x * _ + x.x * F, i.y = g.y * _ + x.y * F, v.isStatic || v.isSleeping || (v.positionPrev.x += i.x * v.inverseMass, v.positionPrev.y += i.y * v.inverseMass, v.anglePrev += r.cross(A, i) * v.inverseInertia), y.isStatic || y.isSleeping || (y.positionPrev.x -= i.x * y.inverseMass, y.positionPrev.y -= i.y * y.inverseMass, y.anglePrev -= r.cross(P, i) * y.inverseInertia)
                        }
                    }
                }
            }
            ...
            ! function() {
                o.collides = function(t, o, s) {
                    ...
                    if (s && u) {
                        ...
                        if (c = e(v.vertices, y.vertices, g), d.reused = !0, c.overlap <= 0) return d.collided = !1, d
                    } else {
                        if ((a = e(t.vertices, o.vertices, t.axes)).overlap <= 0) return d.collided = !1, d;
                        if ((l = e(o.vertices, t.vertices, o.axes)).overlap <= 0) return d.collided = !1, d;
                        a.overlap < l.overlap ? (c = a, d.axisBody = t) : (c = l, d.axisBody = o), d.axisNumber = c.axisNumber
                    }
                    d.bodyA = t.id < o.id ? t : o, d.bodyB = t.id < o.id ? o : t, d.collided = !0, d.depth = c.overlap, d.parentA = d.bodyA.parent, d.parentB = d.bodyB.parent, t = d.bodyA, o = d.bodyB, r.dot(c.axis, r.sub(o.position, t.position)) < 0 ? d.normal = {
                        x: c.axis.x,
                        y: c.axis.y
                    } : d.normal = {
                        x: -c.axis.x,
                        y: -c.axis.y
                    }, d.tangent = r.perp(d.normal), d.penetration = d.penetration || {}, d.penetration.x = d.normal.x * d.depth, d.penetration.y = d.normal.y * d.depth;
                ...
                var e = function(e, n, o) {
                        for (var i, s, a = r._temp[0], l = r._temp[1], c = {
                            ...
                            if (s = o[d], t(a, e, s), t(l, n, s), (i = Math.min(a.max - l.min, l.max - a.min)) <= 0) return c.overlap = i, c;
                    ...
                    n = function(e, t, n) {
                        ...
                        return i = d[s.index - 1 >= 0 ? s.index - 1 : d.length - 1], c.x = i.x - u.x, c.y = i.y - u.y, l = -r.dot(n, c), a = i, i = d[(s.index + 1) % d.length], c.x = i.x - u.x, c.y = i.y - u.y, (o = -r.dot(n, c)) < l && (a = i), [s, a]
                    }
            }()
        }, {
            "../geometry/Vector": 28,
            ...
            ! function() {
                ...
                o.create = function(t) {
                    ...
                    return n.render = c.extend({
                        ...
                        lineWidth: 2,
                        strokeStyle: "#ffffff"
                    }, n.render), n.id = n.id || c.nextId(), n.label = n.label || "Constraint", n.type = "constraint", n.stiffness = n.stiffness || 1, n.angularStiffness = n.angularStiffness || 0, n.angleA = n.bodyA ? n.bodyA.angle : n.angleA, n.angleB = n.bodyB ? n.bodyB.angle : n.angleB, n.plugin = {}, n
                    ...
                    var o = t.bodyA,
                        ...
                        s = t.pointA,
                        a = t.pointB;
                    o && !o.isStatic && (t.pointA = r.rotate(s, o.angle - t.angleA), t.angleA = o.angle), i && !i.isStatic && (t.pointB = r.rotate(a, i.angle - t.angleB), t.angleB = i.angle);
                    var l = s,
                        c = a;
                    if (o && (l = r.add(o.position, s)), i && (c = r.add(i.position, a)), l && c) {
                        var d = r.sub(l, c),
                            u = r.magnitude(d);
                        0 === u && (u = e);
                        var p = (u - t.length) / u,
                        ...
                        if (!(Math.abs(1 - u / t.length) < .001 * n)) {
                            ...
                            }, o.velocity.x = o.position.x - o.positionPrev.x, o.velocity.y = o.position.y - o.positionPrev.y, o.angularVelocity = o.angle - o.anglePrev, v = r.add(o.velocity, r.mult(r.perp(g), o.angularVelocity)), h = r.dot(g, m), w = o.inverseMass + o.inverseInertia * h * h) : (v = {
                                x: 0,
                                y: 0
                            }, w = o ? o.inverseMass : 0), i && !i.isStatic ? (x = {
                                x: c.x - i.position.x - f.x,
                                y: c.y - i.position.y - f.y
                            }, i.velocity.x = i.position.x - i.positionPrev.x, i.velocity.y = i.position.y - i.positionPrev.y, i.angularVelocity = i.angle - i.anglePrev, y = r.add(i.velocity, r.mult(r.perp(x), i.angularVelocity)), b = r.dot(x, m), S = i.inverseMass + i.inverseInertia * b * b) : (y = {
                                x: 0,
                                y: 0
                            }, S = i ? i.inverseMass : 0);
                            var C = r.sub(y, v),
                    ...
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (0 !== o.x || 0 !== o.y || 0 !== o.angle) {
                            ...
                            for (var c = 0; c < n.parts.length; c++) {
                                var d = n.parts[c];
                                i.translate(d.vertices, o), c > 0 && (d.position.x += o.x, d.position.y += o.y), 0 !== o.angle && (i.rotate(d.vertices, o.angle, n.position), l.rotate(d.axes, o.angle), c > 0 && r.rotateAbout(d.position, o.angle, n.position, d.position)), a.update(d.bounds, d.vertices, n.velocity)
                            }
        ...
        13: [function(e, t, n) {
            ...
            ! function() {
                o.create = function(t, n) {
                    ...
                    i || (t && t.render && t.render.canvas ? i = s.create(t.render.canvas) : n && n.element ? i = s.create(n.element) : (i = s.create(), u.warn("MouseConstraint.create: options.mouse was undefined, options.element was undefined, may not function as expected")));
                    var r = {
        ...
        15: [function(e, t, n) {
            ...
            ! function() {
                o.create = function(e, t) {
                    t = (t = m.isElement(e) ? t : e) || {}, ((e = m.isElement(e) ? e : null) || t.render) && m.warn("Engine.create: engine.render is deprecated (see docs)");
                    var n = {
                    ...
                    for (o.enableSleeping && r.update(x, f.timeScale), t(x, m.gravity), n(x, i, f.timeScale, a, m.bounds), c = 0; c < o.constraintIterations; c++) p.solveAll(h, f.timeScale);
                    p.postSolveAll(x), v.controller ? (m.isModified && v.controller.clear(v), v.controller.update(v, x, o, m.isModified), y = v.pairsList) : y = x, m.isModified && u.setModified(m, !1, !1, !0);
                    var b = v.detector(y, o),
                        w = o.pairs,
                        S = f.timestamp;
                    for (l.update(w, b, S), l.removeOld(w, S), o.enableSleeping && r.afterCollisions(w.list, f.timeScale), w.collisionStart.length > 0 && d.trigger(o, "collisionStart", {
                            pairs: w.collisionStart
                        }), s.preSolvePosition(w.list), c = 0; c < o.positionIterations; c++) s.solvePosition(w.list, f.timeScale);
                    for (s.postSolvePosition(x), s.preSolveVelocity(w.list), c = 0; c < o.velocityIterations; c++) s.solveVelocity(w.list, f.timeScale);
                ...
                if (e.events) {
                    ...
                    for (var l = 0; l < o.length; l++)
                        if (r = o[l], s = e.events[r]) {
                            (a = i.clone(n, !1)).name = r, a.source = e;
            ...
            ! function() {
                o.create = function(t) {
                    ...
                    return t || i.log("Mouse.create: element was undefined, defaulting to document.body", "warn"), n.element = t || document.body, n.absolute = {
                        ...
                        t.changedTouches && (n.button = 0, t.preventDefault()), n.absolute.x = o.x, n.absolute.y = o.y, n.position.x = n.absolute.x * n.scale.x + n.offset.x, n.position.y = n.absolute.y * n.scale.y + n.offset.y, n.sourceEvents.mousemove = t
                    }, n.mousedown = function(t) {
                        var o = e(t, n.element, n.pixelRatio);
                        t.changedTouches ? (n.button = 0, t.preventDefault()) : n.button = t.button, n.absolute.x = o.x, n.absolute.y = o.y, n.position.x = n.absolute.x * n.scale.x + n.offset.x, n.position.y = n.absolute.y * n.scale.y + n.offset.y, n.mousedownPosition.x = n.position.x, n.mousedownPosition.y = n.position.y, n.sourceEvents.mousedown = t
                    }, n.mouseup = function(t) {
                        var o = e(t, n.element, n.pixelRatio);
                        t.changedTouches && t.preventDefault(), n.button = -1, n.absolute.x = o.x, n.absolute.y = o.y, n.position.x = n.absolute.x * n.scale.x + n.offset.x, n.position.y = n.absolute.y * n.scale.y + n.offset.y, n.mouseupPosition.x = n.position.x, n.mouseupPosition.y = n.position.y, n.sourceEvents.mouseup = t
        ...
        20: [function(e, t, n) {
            ...
            o._registry = {}, o.register = function(e) {
                ...
                } else i.warn("Plugin.use:", o.toString(e), "does not specify any dependencies to install.")
        ...
        21: [function(e, t, n) {
            ...
            ! function() {
                ...
                o.create = function(e) {
                    ...
                    i.trigger(e, "beforeTick", l), i.trigger(t, "beforeTick", l), e.isFixed ? o = e.delta : (o = n - e.timePrev || e.delta, e.timePrev = n, e.deltaHistory.push(o), e.deltaHistory = e.deltaHistory.slice(-e.deltaSampleSize), a = (o = (o = (o = Math.min.apply(null, e.deltaHistory)) < e.deltaMin ? e.deltaMin : o) > e.deltaMax ? e.deltaMax : o) / e.delta, e.delta = o), 0 !== e.timeScalePrev && (a *= s.timeScale / e.timeScalePrev), 0 === s.timeScale && (a = 0), e.timeScalePrev = s.timeScale, e.correction = a, e.frameCounter += 1, n - e.counterTimestamp >= 1e3 && (e.fps = e.frameCounter * ((n - e.counterTimestamp) / 1e3), e.counterTimestamp = n, e.frameCounter = 0), i.trigger(e, "tick", l), i.trigger(t, "tick", l), t.world.isModified && t.render && t.render.controller && t.render.controller.clear && t.render.controller.clear(t.render), i.trigger(e, "beforeUpdate", l), r.update(t, o, a), i.trigger(e, "afterUpdate", l), t.render && t.render.controller && (i.trigger(e, "beforeRender", l), i.trigger(t, "beforeRender", l), t.render.controller.world(t.render), i.trigger(e, "afterRender", l), i.trigger(t, "afterRender", l)), i.trigger(e, "afterTick", l), i.trigger(t, "afterTick", l)
                }, o.stop = function(e) {
                    t(e.frameRequestId)
        ...
        23: [function(e, t, n) {
            (function(n) {
                ...
                o.rectangle = function(e, t, n, o, a) {
                    ...
                    if (l.chamfer) {
                        var f = l.chamfer;
                        m.vertices = i.chamfer(m.vertices, f.radius, f.quality, f.qualityMin, f.qualityMax), delete l.chamfer
                    }
                    ...
                    for (o = o || {}, f = [], d = void 0 !== d && d, u = void 0 !== u ? u : .01, p = void 0 !== p ? p : 10, c || r.warn("Bodies.fromVertices: poly-decomp.js required. Could not decompose vertices. Fallback to convex hull."), r.isArray(n[0]) || (n = [n]), b = 0; b < n.length; b += 1)
                        if (y = n[b], (v = i.isConvex(y)) || !c) y = v ? i.clockwiseSort(y) : i.hull(y), f.push({
                            position: {
                                x: e,
                                y: t
                            },
                            ...
                            c.makeCCW(S), !1 !== u && c.removeCollinearPoints(S, u);
                    ...
                    for (g = 0; g < f.length; g++) f[g] = s.create(r.extend(f[g], o));
                    if (d)
                                ...
                                if (a.overlaps(P.bounds, B.bounds)) {
                                    ...
                                    for (h = 0; h < P.vertices.length; h++)
                                        for (w = 0; w < B.vertices.length; w++) {
                                            ...
                                            I < 5 && T < 5 && (M[h].isInternal = !0, k[w].isInternal = !0)
                                        }
                                }
                            }
                        }
        ...
        24: [function(e, t, n) {
            ...
            o.stack = function(e, t, n, o, r, s, l) {
                    ...
                    for (var v = 0, y = 0; y < n; y++) {
                        ...
                        if (g) {
                            ...
                            x > v && (v = x), a.translate(g, {
                                x: .5 * h,
                                y: .5 * x
                            }), u = g.bounds.max.x + r, i.addBody(d, g), c = g, m += 1
                        } else u += r
                    }
                    p += v + s, u = e
                }
                ...
                for (l = 0; l < n; l++) {
                    for (c = 1; c < t; c++) d = m[c - 1 + l * t], u = m[c + l * t], i.addConstraint(e, r.create(s.extend({
                        bodyA: d,
                        bodyB: u
                    }, a)));
                    if (l > 0)
                        for (c = 0; c < t; c++) d = m[c + (l - 1) * t], u = m[c + l * t], i.addConstraint(e, r.create(s.extend({
                            bodyA: d,
                            bodyB: u
                        }, a))), o && c > 0 && (p = m[c - 1 + (l - 1) * t], i.addConstraint(e, r.create(s.extend({
                            bodyA: p,
                            bodyB: u
                        }, a)))), o && c < t - 1 && (p = m[c + 1 + (l - 1) * t], i.addConstraint(e, r.create(s.extend({
                            bodyA: p,
                            bodyB: u
                        }, a))))
                }
                ...
                return i.addBody(p, m), i.addBody(p, f), i.addBody(p, v), i.addConstraint(p, y), i.addConstraint(p, g), p
                ...
                return o.mesh(m, n, i, c, p), m.label = "Soft Body", m
            }
        }, {
            "../body/Body": 1,
            "../body/Composite": 2,
        ...
        27: [function(e, t, n) {
            var o = {};
            t.exports = o, e("../geometry/Bounds"),
                function() {
                    o.pathToVertices = function(t, n) {
                        var o, i, r, s, a, l, c, d, u, p, m, f = [],
                            v = 0,
                            y = 0,
                            g = 0;
                        n = n || 15;
                        var x = function(e, t, n) {
                                var o = n % 2 == 1 && n > 1;
                                if (!u || e != u.x || t != u.y) {
                                    u && o ? (p = u.x, m = u.y) : (p = 0, m = 0);
                                    var i = {
                                        x: p + e,
                                        y: m + t
                                    };
                                    !o && u || (u = i), f.push(i), y = p + e, g = m + t
                                }
                            },
                            h = function(e) {
                        ...
                        for (c = l.concat(); v < r;) {
                            ...
                            switch (a.pathSegTypeAsLetter.toUpperCase()) {
                                ...
                                case "Q":
                                case "A":
                                    s = t.getPointAtLength(v), x(s.x, s.y, 0)
                            }
                            v += n
                        }
                        for (o = 0, i = c.length; o < i; ++o) h(c[o]);
                        return f
                    };
                    var e = function(e) {
                        for (var t, n, o, i, r, s, a = e.pathSegList, l = 0, c = 0, d = a.numberOfItems, u = 0; u < d; ++u) {
                            ...
                            if (/[MLHVCSQTA]/.test(m)) "x" in p && (l = p.x), "y" in p && (c = p.y);
                            else switch ("x1" in p && (o = l + p.x1), "x2" in p && (r = l + p.x2), "y1" in p && (i = c + p.y1), "y2" in p && (s = c + p.y2), "x" in p && (l += p.x), "y" in p && (c += p.y), m) {
                                case "m":
        ...
        28: [function(e, t, n) {
            var o = {};
            t.exports = o, o.create = function(e, t) {
                return {
                    x: e || 0,
                    y: t || 0
                }
        ...
        29: [function(e, t, n) {
            ...
            o.create = function(e, t) {
                ...
                for (var n, o, r = 0, s = 0, a = e, l = 0; l < a.length; l++) o = (l + 1) % a.length, r += (n = Math.abs(i.cross(a[o], a[l]))) * (i.dot(a[o], a[o]) + i.dot(a[o], a[l]) + i.dot(a[l], a[l])), s += n;
                return t / 6 * (r / s)
            }, o.translate = function(e, t, n) {
                var o;
                if (n)
                ...
                (t = t || [8]).length || (t = [t]), n = void 0 !== n ? n : -1, o = o || 2, s = s || 14;
                for (var a = [], l = 0; l < e.length; l++) {
                    ...
                    if (0 !== p) {
                        var m = i.normalise({
                            ...
                            h = n; - 1 === n && (h = 1.75 * Math.pow(p, .32)), (h = r.clamp(h, o, s)) % 2 == 1 && (h += 1);
                        for (var b = Math.acos(i.dot(m, f)) / h, w = 0; w < h; w++) a.push(i.add(i.rotate(y, b * w), x))
                    } else a.push(d)
                }
                return a
                ...
                if (s < 3) return null;
                for (t = 0; t < s; t++)
                    if (o = (t + 2) % s, i = (e[n = (t + 1) % s].x - e[t].x) * (e[o].y - e[n].y), (i -= (e[n].y - e[t].y) * (e[o].x - e[n].x)) < 0 ? r |= 1 : i > 0 && (r |= 2), 3 === r) return !1;
                return 0 !== r || null
            }, o.hull = function(e) {
                var t, n, o = [],
                    r = [];
        ...
        31: [function(e, t, n) {
            ...
            ! function() {
                ...
                "undefined" != typeof window && (e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                    ...
                    if (a.trigger(e, "beforeRender", b), e.currentBackground !== g && m(e, g), p.globalCompositeOperation = "source-in", p.fillStyle = "transparent", p.fillRect(0, 0, u.width, u.height), p.globalCompositeOperation = "source-over", f.hasBounds) {
                    ...
                    if (e.debugString) {
                        ...
                        for (var d = e.debugString.split("\n"), u = 0; u < d.length; u++) n.fillText(d[u], 50, 50 + 18 * u)
                    }
                                ...
                                if ((i = o.parts[s]).render.visible) {
                                    if (l.showSleeping && o.isSleeping ? a.globalAlpha = .5 * i.render.opacity : 1 !== i.render.opacity && (a.globalAlpha = i.render.opacity), i.render.sprite && i.render.sprite.texture && !l.wireframes) {
                                        ...
                                        if (i.circleRadius) a.beginPath(), a.arc(i.position.x, i.position.y, i.circleRadius, 0, 2 * Math.PI);
                                            ...
                                            for (var m = 1; m < i.vertices.length; m++) !i.vertices[m - 1].isInternal || c ? a.lineTo(i.vertices[m].x, i.vertices[m].y) : a.moveTo(i.vertices[m].x, i.vertices[m].y), i.vertices[m].isInternal && !c && a.moveTo(i.vertices[(m + 1) % i.vertices.length].x, i.vertices[(m + 1) % i.vertices.length].y);
                    ...
                    for (l.wireframes ? a.fillStyle = "indianred" : a.fillStyle = "rgba(0,0,0,0.5)", a.fill(), a.beginPath(), r = 0; r < t.length; r++)(o = t[r]).render.visible && (a.arc(o.positionPrev.x, o.positionPrev.y, 2, 0, 2 * Math.PI, !1), a.closePath());
                    ...
                    for (l.wireframes ? a.fillStyle = "rgba(255,255,255,0.7)" : a.fillStyle = "orange", a.fill(), a.beginPath(), r = 0; r < t.length; r++)
                        if ((o = t[r]).isActive && (i = o.collision, o.activeContacts.length > 0)) {
                            var d = o.activeContacts[0].vertex.x,
                                u = o.activeContacts[0].vertex.y;
                            2 === o.activeContacts.length && (d = (o.activeContacts[0].vertex.x + o.activeContacts[1].vertex.x) / 2, u = (o.activeContacts[0].vertex.y + o.activeContacts[1].vertex.y) / 2), i.bodyB === i.supports[0].body || !0 === i.bodyA.isStatic ? a.moveTo(d - 8 * i.normal.x, u - 8 * i.normal.y) : a.moveTo(d + 8 * i.normal.x, u + 8 * i.normal.y), a.lineTo(d, u)
                        }
                    ...
                    for (l.beginPath(), a = 0; a < t.length; a++)
                        if ((o = t[a]).isActive) {
                            ...
                            var d = 1;
                            (s = i.bodyB).isStatic || r.isStatic || (d = .5), s.isStatic && (d = 0), l.moveTo(s.position.x, s.position.y), l.lineTo(s.position.x - i.penetration.x * d, s.position.y - i.penetration.y * d), d = 1, s.isStatic || r.isStatic || (d = .5), r.isStatic && (d = 0), l.moveTo(r.position.x, r.position.y), l.lineTo(r.position.x + i.penetration.x * d, r.position.y + i.penetration.y * d)
                        }
                ...
                "undefined" != typeof window && (e = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                    ...
                    if (e.currentBackground !== t) {
                        ...
                        if (n) {
                            ...
                            var r = d(e, t);
                            (o = e.sprites["bg-0"] = new PIXI.Sprite(r)).position.x = 0, o.position.y = 0, e.container.addChildAt(o, 0)
                        }
                    ...
                    if (c.hasBounds) {
                        ...
                        for (t = 0; t < u.length; t++) {
                            var x = u[t],
                                ...
                                w = x.pointA,
                                S = x.pointB;
                            h && (w = l.add(h.position, x.pointA)), b && (S = l.add(b.position, x.pointB)), w && S && (i.contains(e.bounds, w) || i.contains(e.bounds, S)) && p.push(x)
                        }
                        a.scale.set(1 / v, 1 / y), a.position.set(-e.bounds.min.x * (1 / v), -e.bounds.min.y * (1 / y))
                    } else p = u;
                    for (t = 0; t < d.length; t++) o.body(e, d[t]);
                    for (t = 0; t < p.length; t++) o.constraint(e, p[t]);
                    s.render(a)
                    ...
                    var n = (e.engine, t.bodyA),
                        ...
                        c = "c-" + t.id,
                        d = e.primitives[c];
                    return d || (d = e.primitives[c] = new PIXI.Graphics), l.visible && t.pointA && t.pointB ? (-1 === s.indexOf(a.children, d) && a.addChild(d), d.clear(), d.beginFill(0, 0), d.lineStyle(l.lineWidth, s.colorToNumber(l.strokeStyle), 1), n ? d.moveTo(n.position.x + i.x, n.position.y + i.y) : d.moveTo(i.x, i.y), o ? d.lineTo(o.position.x + r.x, o.position.y + r.y) : d.lineTo(r.x, r.y), void d.endFill()) : void d.clear()
                }, o.body = function(e, t) {
                    ...
                    if (o.visible)
                        if (o.sprite && o.sprite.texture) {
                            ...
                            var l = "b-" + t.id,
                                d = e.primitives[l],
                                u = e.container;
                            d || ((d = e.primitives[l] = c(e, t)).initialAngle = t.angle), -1 === s.indexOf(u.children, d) && u.addChild(d), d.position.x = t.position.x, d.position.y = t.position.y, d.rotation = t.angle - d.initialAngle
                        }
                };
                var n = function(e, t) {
                    ...
                    c = function(e, t) {
                        ...
                        for (var p = t.parts.length > 1 ? 1 : 0; p < t.parts.length; p++) {
                            ...
                            for (var m = 1; m < n.vertices.length; m++) r.lineTo(n.vertices[m].x - t.position.x, n.vertices[m].y - t.position.y);
