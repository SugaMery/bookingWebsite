! function(e) {
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function() {
        ...
        if (e(".slider-area").length > 0 && e(".slider-area").closest(".container").parent().addClass("arrow-wrap"), t.hasClass("categorySlider")) {
            ...
            ! function t() {
                requestAnimationFrame(t), document.querySelectorAll(".single").forEach(t => {
                    const a = t.getBoundingClientRect(),
                        i = .5 * window.innerWidth - (a.x + .5 * a.width);
    ...
    })), o(), e("[data-slider-prev], [data-slider-next]").on("click", (function() {
    ...
    function f() {
        ...
        (function() {
            ...
            i('[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]'), e(p).val() && e(p).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(p).removeClass("is-invalid"), a = !0) : (e(p).addClass("is-invalid"), a = !1);
            return a
        })() && jQuery.ajax({
            url: e(u).attr("action"),
            data: t,
    ...
    if (e(u).on("submit", (function(e) {
            e.preventDefault(), f()
        })), l = ".popup-search-box", c = ".searchClose", d = "show", e(".searchBoxToggler").on("click", (function(t) {
            t.preventDefault(), e(l).addClass(d)
        })), e(l).on("click", (function(t) {
            t.stopPropagation(), e(l).removeClass(d)
        })), e(l).find("form").on("click", (function(t) {
    ...
    if (e(".cursor").length) {
        ...
        TweenMax.to({}, .02, {
            repeat: -1,
            onRepeat: function() {
                n += (o - n) / 9, s += (r - s) / 9, TweenMax.set(a, {
                    css: {
                        left: n - 20,
                        top: s - 20
                    }
    ...
    e.fn.sectionPosition = function(t, a) {
        e(this).each((function() {
            ...
            i = Math.floor(l.height() / 2), n = l.attr(t), s = l.attr(a), o = g(e(s).css("padding-top")), r = g(e(s).css("padding-bottom")), "top-half" === n ? (e(s).css("padding-bottom", r + i + "px"), l.css("margin-top", "-" + i + "px")) : "bottom-half" === n && (e(s).css("padding-top", o + i + "px"), l.css("margin-bottom", "-" + i + "px"))
        }))
    };
    ...
    })), v(), e(window).scroll(v), e(".filter-active").imagesLoaded((function() {
